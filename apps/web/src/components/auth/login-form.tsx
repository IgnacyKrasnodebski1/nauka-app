...
export function LoginForm() {
  ...
  return (
    <div className="auth">
      ...
      <h1>{mode === "signup" ? "Załóż konto" : "Zaloguj się"}</h1>
      <p className="sp mb-6">Własne przedmioty, tematy z AI i postępy w chmurze. <b>3 tematy w miesiącu za darmo.</b></p>
      ...
      <button type="button" className="gbtn" onClick={google} disabled={busy || !supabase}>
        <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true"><path className="g1" d="M24 9.5c3.5 0 6.6 1.2 9 3.5l6.7-6.7C35.6 2.5 30.2 0 24 0 14.6 0 6.5 5.4 2.6 13.3l7.8 6C12.3 13.6 17.7 9.5 24 9.5z"/><path className="g2" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v9h12.7c-.6 3-2.2 5.5-4.7 7.2l7.5 5.8c4.4-4 7-10 7-17.5z"/><path className="g3" d="M10.4 28.7c-.5-1.5-.8-3-.8-4.7s.3-3.2.8-4.7l-7.8-6C.9 16.5 0 20.1 0 24s.9 7.5 2.6 10.7l7.8-6z"/><path className="g4" d="M24 48c6.2 0 11.6-2 15.5-5.6l-7.5-5.8c-2.1 1.4-4.8 2.3-8 2.3-6.3 0-11.7-4.1-13.6-9.8l-7.8 6C6.5 42.6 14.6 48 24 48z"/></svg>
        Kontynuuj z Google
      </button>

      <div className="divider-row eyebrow"><span className="divider" />albo e-mail<span className="divider" /></div>
      ...
      <form onSubmit={submit}>
        ...
        <button type="submit" className="pill a-glow" disabled={busy || !supabase}>
      ...
      <div className="chips mt-5" style={{ padding: 0 }}>
      ...
      <p className="text-[12px] text-muted mt-5 font-semibold">Logując się akceptujesz <a className="alink" href="/regulamin">regulamin</a> i <a className="alink" href="/prywatnosc">politykę prywatności</a>.</p>
    </div>
  );
}
