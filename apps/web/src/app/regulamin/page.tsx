  ...
  return (
    <div className="min-h-dvh land">
      ...
      <main className="land-wrap !max-w-3xl py-12 prose">
        <h1 className="mb-8">Regulamin serwisu Recall</h1>
        <h2>1. Czym jest Recall</h2>
        <p>Recall to aplikacja do nauki, która na podstawie materiałów przesłanych przez użytkownika generuje treści edukacyjne (poziomy, fiszki, quizy, mini-gry) z pomocą modeli AI. Usługa jest dostępna w wersji bezpłatnej (Free) i płatnej (Pro).</p>
        <h2>2. Konto</h2>
        ...
        <h2>4. Treści AI</h2>
        <p>Treści generowane przez AI mogą zawierać błędy. Recall to narzędzie pomocnicze — zawsze weryfikuj kluczowe informacje z materiałem źródłowym. Nie ponosimy odpowiedzialności za wynik egzaminu.</p>
