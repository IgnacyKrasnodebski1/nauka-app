  ...
  levels:[
    ...
    {id:"k1",title:"Blockchain — podstawy",emoji:"⛓️",
     ...
     tasks:[
      ...
      /* krok 5b */
      {type:"timeline",title:"Kamienie milowe krypto",events:[{label:"Biała księga Bitcoina",year:2008},{label:"Genesis Block — start sieci",year:2009},{label:"Start Ethereum",year:2015},{label:"Fala ICO",year:2017},{label:"NFT w głównym nurcie",year:2021}],e:"2008 white paper, 2009 start sieci, 2015 Ethereum, 2017 ICO, 2021 NFT."},
      {type:"typeterm",definition:"Ryzyko, że tę samą cyfrową jednostkę pieniądza uda się wydać dwa razy — problem, który Bitcoin rozwiązuje rozproszonym rejestrem i konsensusem.",answer:"double spending",accept:["podwójne wydatkowanie","podwójne wydawanie","double spend"],typo:1,e:"Plik cyfrowy łatwo skopiować; blockchain pilnuje, żeby ta sama moneta nie została wydana dwa razy."},
      {type:"hotspot",title:"Schemat łańcucha bloków",image:"<svg viewBox='0 0 320 200' role='img' aria-label='Schemat: trzy bloki łańcucha połączone strzałkami'><rect x='16' y='40' width='88' height='120' rx='14' style='fill:var(--surface-2);stroke:var(--line);stroke-width:3'/><rect x='116' y='40' width='88' height='120' rx='14' style='fill:var(--surface-2);stroke:var(--line);stroke-width:3'/><rect x='216' y='40' width='88' height='120' rx='14' style='fill:var(--surface-2);stroke:var(--line);stroke-width:3'/><rect x='26' y='50' width='68' height='20' rx='6' style='fill:var(--tint-cyan);stroke:var(--tint-cyan-line);stroke-width:2'/><rect x='126' y='50' width='68' height='20' rx='6' style='fill:var(--tint-cyan);stroke:var(--tint-cyan-line);stroke-width:2'/><rect x='226' y='50' width='68' height='20' rx='6' style='fill:var(--tint-cyan);stroke:var(--tint-cyan-line);stroke-width:2'/><rect x='30' y='54' width='28' height='12' rx='4' style='fill:none;stroke:var(--muted-3);stroke-width:2;stroke-dasharray:3 3'/><rect x='130' y='54' width='28' height='12' rx='4' style='fill:var(--cyan)'/><rect x='230' y='54' width='28' height='12' rx='4' style='fill:var(--cyan)'/><circle cx='84' cy='60' r='5' style='fill:var(--gold)'/><circle cx='184' cy='60' r='5' style='fill:var(--gold)'/><circle cx='284' cy='60' r='5' style='fill:var(--gold)'/><rect x='26' y='84' width='68' height='8' rx='4' style='fill:var(--line)'/><rect x='26' y='98' width='52' height='8' rx='4' style='fill:var(--line)'/><rect x='26' y='112' width='60' height='8' rx='4' style='fill:var(--line)'/><rect x='26' y='126' width='44' height='8' rx='4' style='fill:var(--line)'/><rect x='126' y='84' width='68' height='8' rx='4' style='fill:var(--line)'/><rect x='126' y='98' width='52' height='8' rx='4' style='fill:var(--line)'/><rect x='126' y='112' width='60' height='8' rx='4' style='fill:var(--line)'/><rect x='126' y='126' width='44' height='8' rx='4' style='fill:var(--line)'/><rect x='226' y='84' width='68' height='8' rx='4' style='fill:var(--line)'/><rect x='226' y='98' width='52' height='8' rx='4' style='fill:var(--line)'/><rect x='226' y='112' width='60' height='8' rx='4' style='fill:var(--line)'/><rect x='226' y='126' width='44' height='8' rx='4' style='fill:var(--line)'/><path d='M104 100h9M108 95l5 5-5 5' style='fill:none;stroke:var(--cyan);stroke-width:3;stroke-linecap:round;stroke-linejoin:round'/><path d='M204 100h9M208 95l5 5-5 5' style='fill:none;stroke:var(--cyan);stroke-width:3;stroke-linecap:round;stroke-linejoin:round'/></svg>",
       targets:[{name:"blok genesis",x:18.75,y:50,r:13},{name:"strzałka z bloku 1 do 2 (hash poprzednika)",x:34.4,y:50,r:6},{name:"transakcje w bloku 3",x:81.25,y:55,r:11}],e:"Każdy blok trzyma w nagłówku hash poprzedniego bloku (niebieskie pole i strzałka) — dlatego zmiana jednego wpisu psuje cały łańcuch. Genesis Block jako pierwszy nie ma poprzednika."}
     ]},
    /* ---------------- L2 ---------------- */
    {id:"k2",title:"Konsensus: PoW i PoS",emoji:"⚙️",
     ...
     tasks:[
      ...
      /* krok 5b */
      {type:"chain",title:"Jak powstaje blok w PoS?",steps:["Walidator blokuje kapitał (stake)","Sieć losuje walidatora do zaproponowania bloku","Walidator proponuje nowy blok","Inni walidatorzy potwierdzają blok","Walidator dostaje nagrodę albo traci stake (slashing)"],given:[0,4],bank:["Górnik rozwiązuje zadanie obliczeniowe","Bank centralny zatwierdza blok"],e:"W PoS nie ma wyścigu obliczeniowego: stake → losowanie → propozycja → potwierdzenie → nagroda (albo slashing za oszustwo)."},
      {type:"chart",chart:{kind:"line",label:"Nagroda za wydobycie bloku Bitcoina (BTC)",x:["2009","2012","2016","2020","2024"],y:[50,25,12.5,6.25,3.125]},q:"Co dzieje się z nagrodą za blok przy każdym halvingu?",a:["Spada o połowę","Spada o 25%","Rośnie dwukrotnie","Nie zmienia się — zmienia się tylko trudność"],c:0,e:"Halving co ok. 4 lata (210 000 bloków) dzieli nagrodę na pół: 50 → 25 → 12,5 → 6,25 → 3,125 BTC. Stąd ograniczona podaż 21 mln BTC."}
     ]},
    /* ---------------- L3 ---------------- */
    {id:"k3",title:"Kryptografia i klucze",emoji:"🔐",
     ...
     /* krok 5b */
     tasks:[
      {type:"swipe",title:"Prywatny czy publiczny?",left:"Prywatny",right:"Publiczny",cards:[
        {front:"Podpisuje transakcję",sub:"klucz…",side:"left"},
        {front:"Weryfikuje podpis",sub:"klucz…",side:"right"},
        {front:"Musi zostać tajny",sub:"klucz…",side:"left"},
        {front:"Można go udostępnić",sub:"klucz…",side:"right"},
        {front:"Wyprowadza się z niego adres",sub:"klucz…",side:"right"},
        {front:"Utrata = utrata środków",sub:"klucz…",side:"left"}
      ],e:"Prywatny podpisuje i musi być tajny; publiczny weryfikuje, można go pokazać, a z jego hasha powstaje adres."},
      {type:"thesis",thesis:"Potrzebny jest system płatności oparty na dowodzie kryptograficznym, a nie na zaufaniu do pośredników.",q:"Kto tak napisał?",options:[{name:"Satoshi Nakamoto",sub:"biała księga Bitcoina, 2008"},{name:"Vitalik Buterin",sub:"Ethereum, dApps"},{name:"Ben Bernanke",sub:"Fed, kryzys 2008"},{name:"Christine Lagarde",sub:"Europejski Bank Centralny"}],c:0,e:"To sedno białej księgi Bitcoina (2008): zamiast zaufania do banków — dowód kryptograficzny i rozproszony rejestr."},
      {type:"scenario",scene:"Dostajesz e-mail wyglądający jak wiadomość z giełdy: „Wykryliśmy podejrzaną aktywność. Aby odblokować konto, wpisz swoje 12 słów seed phrase w formularzu”.",q:"Co robisz?",a:["Wpisuję — giełda musi zweryfikować mój portfel","Ignoruję i zgłaszam: seed phrase nigdy nie podaje się nikomu","Wpisuję tylko pierwsze sześć słów","Wysyłam zamiast tego klucz publiczny"],c:1,e:"Seed phrase odtwarza cały portfel. Żadna giełda ani wsparcie techniczne nigdy o niego nie prosi — taka prośba to zawsze phishing."},
      {type:"finderror",sentences:["SHA-256 zwraca skrót o długości 256 bitów.","Ta sama wiadomość daje zawsze ten sam hash.","Z hasha da się odtworzyć pierwotne dane.","Mała zmiana danych daje zupełnie inny hash (efekt lawiny)."],wrong:2,fix:"nie da się odtworzyć — hash jest nieodwracalny",e:"Funkcja hashująca jest jednokierunkowa: sprawdza integralność danych, ale nie da się jej „odszyfrować”."},
      {type:"mathsteps",title:"Ile to znaków i bajtów?",start:"SHA-256 = 256 bitów",steps:[
        {expr:"256 : 4 = 64 znaki hex",note:"jeden znak szesnastkowy koduje 4 bity",options:["256 : 4 = 64 znaki hex","256 : 8 = 32 znaki hex","256 · 4 = 1024 znaki hex"],c:0},
        {expr:"256 : 8 = 32 bajty",note:"jeden bajt to 8 bitów",options:["256 : 8 = 32 bajty","256 : 16 = 16 bajtów","64 · 2 = 128 bajtów","256 : 2 = 128 bajtów"],c:0}
      ],e:"SHA-256 = 256 bitów = 32 bajty = 64 znaki szesnastkowe."}
     ]},
    /* ---------------- L4 ---------------- */
